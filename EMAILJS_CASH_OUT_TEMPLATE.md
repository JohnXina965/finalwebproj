# EmailJS Withdrawal Template - template_fzimfn7

## 📧 Template Configuration

**Template ID:** `template_fzimfn7`  
...
This template is used for **Withdrawal confirmation emails** when users withdraw funds from their wallet to PayPal.
...
- `amount` - Amount withdrawn (formatted as ₱X,XXX.XX)
- `amount_withdrawn` - Amount withdrawn (formatted as ₱X,XXX.XX)
- `new_balance` - New wallet balance (formatted as ₱X,XXX.XX)
- `new_wallet_balance` - New wallet balance (formatted as ₱X,XXX.XX)
- `paypal_email` - PayPal email where money was sent
...
Copy this HTML into your EmailJS template `template_fzimfn7`:
...
<div style="font-family: system-ui, -apple-system, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; font-size: 16px; line-height: 1.6; color: #333333; max-width: 600px; margin: 0 auto; background-color: #ffffff;">
  ...
  <div style="padding: 30px;">
    <h2 style="color: #1f2937; font-size: 24px; font-weight: 700; margin: 0 0 20px; text-align: center;">Withdrawal Confirmation</h2>
    ...
    <p style="color: #4b5563; margin: 20px 0; font-size: 18px;">
      This is a confirmation that you have successfully withdrawn funds from your EcoExpress e-wallet. 💸
    </p>

    <!-- Withdrawal Details -->
    <div style="background: #fef2f2; border-left: 4px solid #ef4444; border-radius: 8px; padding: 24px; margin: 30px 0;">
      <h3 style="color: #991b1b; font-size: 18px; font-weight: 600; margin: 0 0 20px; text-align: center;">Withdrawal Details</h3>
      
      <div style="background: #ffffff; border-radius: 6px; padding: 20px; margin-bottom: 16px;">
        <p style="margin: 0 0 8px 0; color: #6b7280; font-size: 14px; text-transform: uppercase; letter-spacing: 0.5px;">Amount Withdrawn</p>
        <p style="margin: 0; color: #dc2626; font-weight: 700; font-size: 32px;">{{amount_withdrawn}}</p>
      </div>
      ...
      <div style="border-top: 1px solid #fecaca; padding-top: 16px; margin-top: 16px;">
        <p style="margin: 8px 0; color: #374151; font-size: 14px;"><strong>PayPal Email:</strong> {{paypal_email}}</p>
        <p style="margin: 8px 0; color: #374151; font-size: 14px;"><strong>Date & Time:</strong> {{date_time}}</p>
        <p style="margin: 8px 0; color: #6b7280; font-family: monospace; font-size: 12px;"><strong>Payout ID:</strong> {{payout_id}}</p>
      </div>
    </div>
    ...
    <div style="background-color: #fef3c7; border: 1px solid #fcd34d; border-radius: 8px; padding: 16px; margin: 20px 0;">
      <p style="color: #92400e; margin: 0; font-size: 14px; text-align: center;">
        💸 Your withdrawal has been processed. The funds should appear in your PayPal account shortly.
      </p>
    </div>

    <p style="color: #6b7280; font-size: 14px; margin: 30px 0 20px;">
      If you have any questions or don't see the funds in your PayPal account, please contact our support team.
    </p>
...
- ✅ Clean, modern design
- ✅ Red/orange color scheme (for withdrawal/outgoing transaction)
- ✅ Large, prominent amount display
- ✅ Clear PayPal email and payout ID
- ✅ Transaction details
- ✅ Professional footer

---

## 🔑 Key Differences from Cash-In Template

- **Color scheme:** Red/orange (withdrawal) vs Green (cash-in)
- **Icon:** 💸 (withdrawal) vs 💰 (cash-in)
- **Additional field:** PayPal email and payout ID
- **Message tone:** Slightly more cautious (funds transfer)

---

**Copy this HTML into your EmailJS template `template_fzimfn7` and save it!** 🎉
