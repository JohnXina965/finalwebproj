...
const HostPolicyCompliance = () => {
  ...
  const policyContent = {
    ...
    cancellationPolicy: {
      ...
      content: `
        <h3 class="text-lg font-semibold mb-4">Cancellation & Refund Policy</h3>
        <p class="mb-4">Understand our cancellation terms, refund calculations, and admin deductions:</p>
        ...
        <ul class="list-disc list-inside mb-4 space-y-1">
          ...
          <li>Guests receive full refund for host cancellations (no admin deduction)</li>
        </ul>

        <h4 class="font-semibold mb-2">Guest Cancellations - Policy Types</h4>
        <p class="mb-2 text-sm text-gray-600">Refund amounts are calculated based on the cancellation policy selected by the host:</p>
        
        <div class="mb-4 p-3 bg-blue-50 rounded-lg border border-blue-200">
          <h5 class="font-semibold text-blue-900 mb-2">Flexible Policy</h5>
          <ul class="list-disc list-inside text-sm space-y-1 text-blue-800">
            <li>Full refund if cancelled 24+ hours before check-in</li>
            <li>50% refund if cancelled less than 24 hours before check-in</li>
          </ul>
        </div>

        <div class="mb-4 p-3 bg-green-50 rounded-lg border border-green-200">
          <h5 class="font-semibold text-green-900 mb-2">Moderate Policy (Default)</h5>
          <ul class="list-disc list-inside text-sm space-y-1 text-green-800">
            <li>Full refund if cancelled 5+ days before check-in</li>
            <li>50% refund if cancelled 1-4 days before check-in</li>
            <li>No refund if cancelled less than 24 hours before check-in</li>
          </ul>
        </div>

        <div class="mb-4 p-3 bg-orange-50 rounded-lg border border-orange-200">
          <h5 class="font-semibold text-orange-900 mb-2">Strict Policy</h5>
          <ul class="list-disc list-inside text-sm space-y-1 text-orange-800">
            <li>50% refund if cancelled 14+ days before check-in</li>
            <li>25% refund if cancelled 7-13 days before check-in</li>
            <li>No refund if cancelled less than 7 days before check-in</li>
          </ul>
        </div>

        <h4 class="font-semibold mb-2">Admin Deduction</h4>
        <div class="mb-4 p-4 bg-yellow-50 rounded-lg border border-yellow-300">
          <p class="text-sm text-gray-800 mb-2">
            <strong>Important:</strong> A 10% admin deduction is applied to all refundable amounts from guest cancellations.
          </p>
          <p class="text-xs text-gray-600 mb-2">Refund Calculation Formula:</p>
          <div class="bg-white p-3 rounded border border-yellow-200 text-xs font-mono">
            <p class="mb-1">1. Calculate refundable amount based on policy</p>
            <p class="mb-1">2. Apply 10% admin deduction: Admin Fee = Refundable Amount × 10%</p>
            <p class="mb-0">3. Final Refund = Refundable Amount - Admin Fee</p>
          </div>
          <p class="text-xs text-gray-600 mt-2">
            <strong>Example:</strong> If a guest cancels and is eligible for ₱10,000 refund, 
            the admin deduction is ₱1,000 (10%), and the guest receives ₱9,000.
          </p>
        </div>

        <h4 class="font-semibold mb-2">Refund Processing</h4>
        <ul class="list-disc list-inside mb-4 space-y-1">
          <li>Refunds are automatically calculated and processed upon cancellation</li>
          <li>Refund amount (after admin deduction) is added to guest's wallet</li>
          <li>Guests receive email confirmation with detailed refund breakdown</li>
          <li>Refunds typically appear in wallet within 3-5 business days</li>
        </ul>
        ...
        <p class="text-sm text-gray-600 italic">
          Note: Extenuating circumstances may qualify for full refunds without admin deduction, subject to review.
        </p>
      `
    },
    communityStandards: {
  ...
  return (
    <div className={`min-h-screen bg-gray-50 py-8 animate-multi-layer transition-all duration-1000 ${
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        {/* Policy Cards - UPDATED LAYOUT */}
        <div className={`bg-white rounded-xl shadow-sm p-6 mb-6 transition-all duration-700 delay-400 ${
          mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
        }`}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* Terms of Service */}
            <div className="flex flex-col p-4 border border-gray-200 rounded-lg transition-all duration-500 delay-500 hover:shadow-md hover:-translate-y-0.5 h-full">
              <div className="flex items-start space-x-4 flex-1">
                ...
                <div className="flex-1 transition-all duration-500 delay-700">
                  ...
                  <p className="text-gray-600 text-sm mb-3 transition-all duration-500 delay-900 line-clamp-3">
              ...
              <button
                ...
                className="text-teal-600 hover:text-teal-700 text-sm font-medium underline transition-all duration-300 delay-1000 hover:scale-105 mt-3 self-start"
              >
            ...
            {/* Privacy Policy */}
            <div className="flex flex-col p-4 border border-gray-200 rounded-lg transition-all duration-500 delay-600 hover:shadow-md hover:-translate-y-0.5 h-full">
              <div className="flex items-start space-x-4 flex-1">
                ...
                <div className="flex-1 transition-all duration-500 delay-800">
                  ...
                  <p className="text-gray-600 text-sm mb-3 transition-all duration-500 delay-1000 line-clamp-3">
              ...
              <button
                ...
                className="text-teal-600 hover:text-teal-700 text-sm font-medium underline transition-all duration-300 delay-1100 hover:scale-105 mt-3 self-start"
              >
                Read Privacy Policy
              </button>
            </div>
            ...
            {/* Hosting Rules */}
            <div className="flex flex-col p-4 border border-gray-200 rounded-lg transition-all duration-500 delay-700 hover:shadow-md hover:-translate-y-0.5 h-full">
              <div className="flex items-start space-x-4 flex-1">
                ...
                <div className="flex-1 transition-all duration-500 delay-900">
                  ...
                  <p className="text-gray-600 text-sm mb-3 transition-all duration-500 delay-1100 line-clamp-3">
              ...
              <button
                ...
                className="text-teal-600 hover:text-teal-700 text-sm font-medium underline transition-all duration-300 delay-1200 hover:scale-105 mt-3 self-start"
              >
                Read Hosting Rules
              </button>
            </div>
            ...
            {/* Safety Guidelines */}
            <div className="flex flex-col p-4 border border-gray-200 rounded-lg transition-all duration-500 delay-800 hover:shadow-md hover:-translate-y-0.5 h-full">
              <div className="flex items-start space-x-4 flex-1">
                ...
                <div className="flex-1 transition-all duration-500 delay-1000">
                  ...
                  <p className="text-gray-600 text-sm mb-3 transition-all duration-500 delay-1200 line-clamp-3">
              ...
              <button
                ...
                className="text-teal-600 hover:text-teal-700 text-sm font-medium underline transition-all duration-300 delay-1300 hover:scale-105 mt-3 self-start"
              >
            ...
            {/* Cancellation Policy */}
            <div className="flex flex-col p-4 border border-gray-200 rounded-lg transition-all duration-500 delay-900 hover:shadow-md hover:-translate-y-0.5 h-full">
              <div className="flex items-start space-x-4 flex-1">
                ...
                <div className="flex-1 transition-all duration-500 delay-1100">
                  ...
                  <p className="text-gray-600 text-sm mb-3 transition-all duration-500 delay-1300 line-clamp-3">
              ...
              <button
                ...
                className="text-teal-600 hover:text-teal-700 text-sm font-medium underline transition-all duration-300 delay-1400 hover:scale-105 mt-3 self-start"
              >
            ...
            {/* Community Standards */}
            <div className="flex flex-col p-4 border border-gray-200 rounded-lg transition-all duration-500 delay-1000 hover:shadow-md hover:-translate-y-0.5 h-full">
              <div className="flex items-start space-x-4 flex-1">
                ...
                <div className="flex-1 transition-all duration-500 delay-1200">
                  ...
                  <p className="text-gray-600 text-sm mb-3 transition-all duration-500 delay-1400 line-clamp-3">
              ...
              <button
                ...
                className="text-teal-600 hover:text-teal-700 text-sm font-medium underline transition-all duration-300 delay-1500 hover:scale-105 mt-3 self-start"
              >
      ...
      {/* Policy Modal */}
      {activeModal && (
       <div className="fixed inset-0 bg-gradient-to-br from-black/70 to-black/50 flex items-center justify-center p-4 z-50 transition-all duration-300">
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-hidden transform transition-all duration-300 scale-95 animate-in fade-in-90 zoom-in-95">
