...
function GuestServices() {
  ...
  // Fetch real-time services from Firestore
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(q, (snapshot) => {
      console.log('📊 Raw services snapshot (Guest):', snapshot.size, 'documents');
      ...
      const allServices = snapshot.docs.map(doc => {
        ...
        return {
          ...
          category: data.serviceDetails?.serviceCategory || data.serviceDetails?.category || 'Accommodation',
          price: `₱${parseFloat(data.pricing?.basePrice || 0).toLocaleString('en-PH')}`,
          rating: data.rating || 0,
          reviews: data.reviewCount || 0,
          image: (typeof data.photos?.[0] === 'string' ? data.photos[0] : data.photos?.[0]?.url) || '🏨',
          ...
          description: data.serviceDetails?.description || data.description || 'Service description not available.',
      ...
      // Filter for published services (client-side filtering)
  ...
  useEffect(() => {
    try { localStorage.setItem('ee_favorites_services', JSON.stringify(favorites)); } catch (e) {}
  }, [favorites]);
  ...
  useEffect(() => {
    ...
    if (video) {
      const handleError = () => {
        console.error('Service video failed to load');
        setVideoError(true);
      };
  ...
  const services = useMemo(() => {
    ...
    if (searchFilters.guests) {
      // For services, we might want to filter by capacity if available
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative text-white py-16 overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-20 relative z-10">
          <div className="max-w-4xl mx-auto text-center mb-8">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 drop-shadow-lg">Member Services</h1>
            <p className="text-xl text-white max-w-2xl mx-auto drop-shadow-md">
              Discover eco-friendly services that make your sustainable travel experience seamless.
            </p>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-2xl">
              ...
              <div className="border-t border-gray-200 px-4 py-3 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  {(searchFilters.category || searchFilters.location || searchFilters.date || searchFilters.maxPrice < 100000) && (
                    <button 
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-8">
          <p className="text-gray-600 text-lg">Showing {services.length} services</p>
          <select 
            value={sortBy}
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-8">
            ...
            <div 
              key={service.id} 
              className="bg-white rounded-xl shadow-sm hover:shadow-lg border border-gray-100 transition-transform duration-300 overflow-hidden group hover:-translate-y-1"
            ...
            >
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-3">
                  <h3 className="text-xl font-bold text-gray-900 group-hover:text-teal-600 transition-colors duration-300 line-clamp-2 flex-1 pr-2">{service.title}</h3>
