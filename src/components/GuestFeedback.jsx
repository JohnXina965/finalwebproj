...
const GuestFeedback = ({ onClose, listingId = null, bookingId = null }) => {
  const { currentUser } = useAuth();
  const navigate = useNavigate();
  const [searchParams] = useSearchParams();
  
  // Get listingId and bookingId from URL params if not provided as props
  ...
  const feedbackTypes = [
    { value: 'listing_issue', label: 'Listing Issue', icon: '🏠', description: 'Misleading photos, cleanliness, accuracy' },
    { value: 'host_behavior', label: 'Host Behavior', icon: '👤', description: 'Inappropriate or concerning host behavior' },
